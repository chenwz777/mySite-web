    ...
    '<div class="viewer-container">' +
      ...
      '<div class="viewer-footer">' +
        ...
        '<ul class="viewer-toolbar">' +
          '<li class="viewer-zoom-in" data-action="zoom-in" title="放大图片"></li>' +
          '<li class="viewer-zoom-out" data-action="zoom-out" title="缩小图片"></li>' +
          '<li class="viewer-one-to-one" data-action="one-to-one" title="实际大小"></li>' +
          '<li class="viewer-reset" data-action="reset" title="刷新"></li>' +
          '<li class="viewer-prev" data-action="prev" title="上一张"></li>' +
          '<li class="viewer-play" data-action="play" title="全屏播放"></li>' +
          '<li class="viewer-next" data-action="next" title="下一张"></li>' +
          '<li class="viewer-rotate-left" data-action="rotate-left" title="向左旋转"></li>' +
          '<li class="viewer-rotate-right" data-action="rotate-right" title="向右旋转"></li>' +
          '<li class="viewer-flip-horizontal" data-action="flip-horizontal" title="水平旋转"></li>' +
          '<li class="viewer-flip-vertical" data-action="flip-vertical" title="垂直旋转"></li>' +
        '</ul>' +
