...
t.attr("id",_99.id||"");
//var _9a=$("<span class=\"l-btn-left\"></span>").appendTo(t); vvise
var _9a=$("<span class=\"l-btn-left\"></span>").addClass(_99.iconCls).appendTo(t);
if(_99.text){
...
///vvise///
$("<input id=\""+_4e5+"\" "+mls+"  type=\""+opts.type+"\" class=\"textbox-text\" autocomplete=\"off\">").prependTo(tb);
}
...
//---vvise update--------
var _6c1={sortName:opts.sortName,sortOrder:opts.sortOrder,sortNum:opts.sortNum};
...
//----vvise add--------------
if(typeof(_6c1.sortNum) == 'undefined'){
	_6c1.sortNum = 0;
}
_6c1.sortNum = _6c1.sortNum + 1;
//----vvise add end---------------
}
...
if(opts.sortNum % 3 != 0){//---判断 vvise add------
	...
	opts.onSortColumn.call(_6be,'',opts.sortOrder);
}
};
